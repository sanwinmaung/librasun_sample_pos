	...
	<div class="container-fluid">
		...
		<div class="over-select">
			...
			<div class="row">
				...
				@endforeach
				<hr style="margin-top: 15px;margin-bottom: 15px;border-top: 1px dashed;">

				<div class="row">
					<div class="total-info">
						<div class="col-sm-6 col-xs-6 total-label-right">
							<h5>Sub Total</h5>
						...
						<div class="col-sm-3 col-xs-3 total-amount-right">
							<h5>{{ sprintf("%.2f", $data->total_cost) }}</h5>
							@if(!is_null($data->discount_amount)) <h5>{{ $data->discount_amount }}</h5> @endif
							<h5>{{ sprintf("%.2f", $data->net_amount) }}</h5>
							<h5>{{ sprintf("%.2f", $data->net_amount) }}</h5>
						</div>
					</div>
				</div>
				...
				<div class="row" style="margin-top: 50px;">
					<div class="total-info">
						<div class="col-md-6 col-sm-6 col-xs-6 total-label-right">
							<!-- <a href="" class="btn btn-primary text-right">Finished</a> -->
						</div>
						<div class="col-md-6 col-sm-6 col-xs-6 proceed-button-right">
							<a href="{{ route('pos.index') }}" class="btn btn-primary finish-vocher">Finished</a>
							<a href="{{ route('download.vocher', $data->id) }}" class="btn btn-success print-vocher">Print Vocher</a>
						</div>
					</div>
				</div>

				<div class="center" style="margin-top: 30px !important;margin-bottom: 30px;">
